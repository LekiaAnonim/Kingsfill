...
class BatchAdmin(admin.ModelAdmin):
    fields = ('batch_name', 'date_created', 'cost', 'kg', 'price_per_kg', 'vendor_name')
    list_display = ('batch_name', 'date_created', 'cost', 'kg', 'price_per_kg', 'vendor_name')
...
class SaleAdmin(admin.ModelAdmin):
    ...
    list_display = ('kg', 'price', 'date', 'customer_name', 'customer_phone')
